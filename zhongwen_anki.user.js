...
(async function() {
    ...
    // The name of the field where the word (i.e. the highlighted text, just like with ALT+[1-8]/Skritter)
    ...
    // Whether or not to automatically open the Anki card browser after pressing the key.
